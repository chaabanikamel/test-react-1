...
export const singUpValidation = yup.object({
  name: yup.string().min(1).required("Please enter the name of the product"),
  quantity: yup.number().min(1000, "Please enter more than 1000 products").required("Quantity is required"),
  company: yup.string().min(5).required("Please enter a valid company"),
  price: yup.string().min(1).required("Please enter a valid price"),
